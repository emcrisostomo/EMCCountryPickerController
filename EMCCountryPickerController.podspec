#
#  Be sure to run `pod spec lint EMCCountryPickerController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Enrico M. Crisostomo"
  # s.authors            = { "Enrico M. Crisostomo" => "enrico.m.crisostomo@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Enrico M. Crisostomo"
  ...
  s.source       = { :git => "https://github.com/emcrisostomo/EMCCountryPickerController.git", :tag => "0.0.1" }
